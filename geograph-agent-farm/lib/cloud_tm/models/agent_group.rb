...
module CloudTm
  class AgentGroup
    ...
    def self.boot(opts)
      ...
      retries = 0
      track_filter_type = nil
      track_filter_value = nil
      ...
      begin
        ...
        tx_monitor do
          ...
          track_filter_type = agent_group.track_filter_type
          track_filter_value = agent_group.track_filter_value
      ...
      agents_ids.each do |agent_id|
        ...
        klass.background(simulator_opts).simulate(
          {:agent_id => agent_id,
           :step => delay,
           :track_filter_type => track_filter_type,
           :track_filter_value => track_filter_value,
    ...
    def inspect
      {:name => name, :agents_type => agents_type, :delay => delay, :track_filter_type => track_filter_type, :track_filter_value => track_filter_value}.inspect
    end
