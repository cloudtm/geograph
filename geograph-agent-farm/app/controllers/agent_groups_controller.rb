...
class AgentGroupsController < ApplicationController
  ...
  around_filter :controller_monitor, :except => :create
  ...
  def create
    ...
    CloudTm::Route.load_routes #FIXME: Move at benchmark service boot
    tx_monitor do
      ...
      group_options[:track_filter_type] = group_options[:track_filter_type]
      group_options[:track_filter_value] = group_options[:track_filter_value]
